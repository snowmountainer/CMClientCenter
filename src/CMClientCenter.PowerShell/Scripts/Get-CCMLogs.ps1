# Get-CCMLogs.ps1 — PS 5.1 kompatibel
# Parameter: $LogName (Dateiname ohne Pfad), $MaxLines (Default 200)
...
if (-not (Test-Path $logFile)) {
    ...
    if (-not (Test-Path $logFile)) {
        [PSCustomObject]@{ Error = "Log nicht gefunden: $logFile" }
        return
    }
}
...
# CMTrace-Format parsen: <![LOG[Message]LOG]!><time="..." date="..." component="..." type="1|2|3">
