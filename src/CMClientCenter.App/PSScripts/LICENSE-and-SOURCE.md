...
The scripts in this folder (and its subfolders `DO`, `FIX`, `GET`,
`SCCM-DP`) originate from the **"Client Center for Configuration Manager"**
project by Roger Zander:

  https://github.com/rzander/sccmclictr
  (Plugins/Plugin_PSScripts/PSScripts)

They are distributed there under the **Microsoft Public License (Ms-PL)**,
which permits reproduction, modification, and redistribution. The full
license text is reproduced below as required by the Ms-PL.
